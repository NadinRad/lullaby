...
Allproducts.forEach(el => {
    ...
    const stepper = currentProduct.querySelector('.product-stepper');
    const stepperInput = stepper.querySelector('.product-stepper__input');
    const stepperBtnUp = stepper.querySelector('.product-stepper__btn--up');
    const stepperBtnDown = stepper.querySelector('.product-stepper__btn--down');
    ...
    stepperInput.addEventListener('keyup', (e) => {
        ...
        if (count == 1) {
            stepperBtnDown.classList.add('product-stepper__btn--disabled');
        } else {
            stepperBtnDown.classList.remove('product-stepper__btn--disabled');
        }
    });
